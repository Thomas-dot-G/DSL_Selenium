 ...
 */
package browser_Selenium.ui.internal;
 ...
 * introduced subclass. 
 */
public class Browser_SeleniumActivator extends AbstractUIPlugin {

	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(Browser_SeleniumActivator.class);
	
	private static Browser_SeleniumActivator INSTANCE;
	...
	public static Browser_SeleniumActivator getInstance() {
		return INSTANCE;
	}
