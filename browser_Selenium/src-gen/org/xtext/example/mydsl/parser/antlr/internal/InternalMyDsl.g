...
entryRuleFuncVar returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getFuncVarRule()); }
	iv_ruleFuncVar=ruleFuncVar
	{ $current=$iv_ruleFuncVar.current; }
	EOF;

// Rule FuncVar
ruleFuncVar returns [EObject current=null]
@init {
	enterRule();
}
@after {
