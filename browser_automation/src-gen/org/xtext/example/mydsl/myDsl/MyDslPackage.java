...
public interface MyDslPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Html func</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int VERIFY__HTML_FUNC = ACTION_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int STORE__VAR = OPERATION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int STORE__ELT = OPERATION_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int STORE_FEATURE_COUNT = OPERATION_FEATURE_COUNT + 3;
  ...
  /**
   * The meta object id for the '{@link org.xtext.example.mydsl.myDsl.impl.FindIfImpl <em>Find If</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.xtext.example.mydsl.myDsl.impl.FindIfImpl
   * @see org.xtext.example.mydsl.myDsl.impl.MyDslPackageImpl#getFindIf()
   * @generated
   */
  int FIND_IF = 20;
   ...
   * @ordered
   */
  int FIND_IF__ADD = ACTION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int FIND_IF__OPERATIONS = ACTION_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int FIND_IF__ELT = ACTION_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int FIND_IF__TEXT = ACTION_FEATURE_COUNT + 3;

  /**
   * The number of structural features of the '<em>Find If</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int FIND_IF_FEATURE_COUNT = ACTION_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int VARIABLE__TAGS = CONDITION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int VARIABLE__NAME = CONDITION_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int VARIABLE_FEATURE_COUNT = CONDITION_FEATURE_COUNT + 2;
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.mydsl.myDsl.Verify#getHtml_func <em>Html func</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Html func</em>'.
   * @see org.xtext.example.mydsl.myDsl.Verify#getHtml_func()
   * @see #getVerify()
   * @generated
   */
  EReference getVerify_Html_func();
  ...
  /**
   * Returns the meta object for the attribute '{@link org.xtext.example.mydsl.myDsl.Store#getVar <em>Var</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Var</em>'.
   * @see org.xtext.example.mydsl.myDsl.Store#getVar()
   * @see #getStore()
   * @generated
   */
  EAttribute getStore_Var();
  ...
  /**
   * Returns the meta object for class '{@link org.xtext.example.mydsl.myDsl.FindIf <em>Find If</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Find If</em>'.
   * @see org.xtext.example.mydsl.myDsl.FindIf
   * @generated
   */
  EClass getFindIf();

  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.mydsl.myDsl.FindIf#getElt <em>Elt</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Elt</em>'.
   * @see org.xtext.example.mydsl.myDsl.FindIf#getElt()
   * @see #getFindIf()
   * @generated
   */
  EReference getFindIf_Elt();

  /**
   * Returns the meta object for the containment reference '{@link org.xtext.example.mydsl.myDsl.FindIf#getText <em>Text</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Text</em>'.
   * @see org.xtext.example.mydsl.myDsl.FindIf#getText()
   * @see #getFindIf()
   * @generated
   */
  EReference getFindIf_Text();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.xtext.example.mydsl.myDsl.Element#getTags <em>Tags</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Tags</em>'.
   * @see org.xtext.example.mydsl.myDsl.Element#getTags()
   * @see #getElement()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Html func</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference VERIFY__HTML_FUNC = eINSTANCE.getVerify_Html_func();
     ...
     * @generated
     */
    EAttribute STORE__VAR = eINSTANCE.getStore_Var();
    ...
    /**
     * The meta object literal for the '{@link org.xtext.example.mydsl.myDsl.impl.FindIfImpl <em>Find If</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.xtext.example.mydsl.myDsl.impl.FindIfImpl
     * @see org.xtext.example.mydsl.myDsl.impl.MyDslPackageImpl#getFindIf()
     * @generated
     */
    EClass FIND_IF = eINSTANCE.getFindIf();
     ...
     * @generated
     */
    EReference FIND_IF__ELT = eINSTANCE.getFindIf_Elt();
     ...
     * @generated
     */
    EReference FIND_IF__TEXT = eINSTANCE.getFindIf_Text();
