...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  private EClass findIfEClass = null;
   ...
   * @generated
   */
  public EReference getVerify_Html_func()
  {
   ...
   * @generated
   */
  public EReference getFindIf_Elt()
  {
    return (EReference)findIfEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getFindIf_Text()
  {
    return (EReference)findIfEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(verifyEClass, VERIFY__HTML_FUNC);
    ...
    findIfEClass = createEClass(FIND_IF);
    createEReference(findIfEClass, FIND_IF__ELT);
    createEReference(findIfEClass, FIND_IF__TEXT);
  ...
  public void initializePackageContents()
  {
    ...
    findIfEClass.getESuperTypes().add(this.getAction());
    findIfEClass.getESuperTypes().add(this.getCondition());
    ...
    initEReference(getVerify_Html_func(), this.getText(), null, "html_func", null, 0, 1, Verify.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(findIfEClass, FindIf.class, "FindIf", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFindIf_Elt(), this.getElement(), null, "elt", null, 0, 1, FindIf.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getFindIf_Text(), this.getText(), null, "text", null, 0, 1, FindIf.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
