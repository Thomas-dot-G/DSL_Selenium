...
public class MyDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        FindIf findIf = (FindIf)theEObject;
        T result = caseFindIf(findIf);
        if (result == null) result = caseAction(findIf);
        if (result == null) result = caseCondition(findIf);
        if (result == null) result = caseWhileLoop(findIf);
        if (result == null) result = caseDoLoop(findIf);
        if (result == null) result = caseLoop(findIf);
        if (result == null) result = caseOperation(findIf);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Find If</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Find If</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseFindIf(FindIf object)
  {
    return null;
  }
