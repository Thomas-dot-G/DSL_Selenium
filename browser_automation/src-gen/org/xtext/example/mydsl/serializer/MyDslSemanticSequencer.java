...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MyDslPackage.eINSTANCE)
			...
			case MyDslPackage.FILL:
				...
				return; 
			case MyDslPackage.FIND_IF:
				if (rule == grammarAccess.getDoLoopRule()) {
					sequence_DoLoop_FindIf(context, (FindIf) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getOperationRule()
						|| rule == grammarAccess.getLoopRule()) {
					sequence_DoLoop_FindIf_WhileLoop(context, (FindIf) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getActionRule()
						|| rule == grammarAccess.getConditionRule()
						|| rule == grammarAccess.getFindIfRule()) {
					sequence_FindIf(context, (FindIf) semanticObject); 
					return; 
				}
				else if (rule == grammarAccess.getWhileLoopRule()) {
					sequence_FindIf_WhileLoop(context, (FindIf) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Contexts:
	 *     DoLoop returns FindIf
	 *
	 * Constraint:
	 *     (elt=Element text=Text add+=AddCondition* operations+=Operation*)
	 */
	protected void sequence_DoLoop_FindIf(ISerializationContext context, FindIf semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     Operation returns FindIf
	 *     Loop returns FindIf
	 *
	 * Constraint:
	 *     (elt=Element text=Text ((add+=AddCondition* operations+=Operation*) | (add+=AddCondition* operations+=Operation*)))
	 */
	protected void sequence_DoLoop_FindIf_WhileLoop(ISerializationContext context, FindIf semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=STRING add+=AddCondition* operations+=Operation*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=STRING ((add+=AddCondition* operations+=Operation*) | (add+=AddCondition* operations+=Operation*)))
	 */
	 ...
	 *
	 * Constraint:
	 *     (elt=Element html_func=Text add+=AddCondition* operations+=Operation*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (elt=Element html_func=Text ((add+=AddCondition* operations+=Operation*) | (add+=AddCondition* operations+=Operation*)))
	 */
	...
	/**
	 * Contexts:
	 *     Action returns FindIf
	 *     Condition returns FindIf
	 *     FindIf returns FindIf
	 *
	 * Constraint:
	 *     (elt=Element text=Text)
	 */
	protected void sequence_FindIf(ISerializationContext context, FindIf semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.FIND_IF__ELT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.FIND_IF__ELT));
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.FIND_IF__TEXT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.FIND_IF__TEXT));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFindIfAccess().getEltElementParserRuleCall_2_0(), semanticObject.getElt());
		feeder.accept(grammarAccess.getFindIfAccess().getTextTextParserRuleCall_4_0(), semanticObject.getText());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     WhileLoop returns FindIf
	 *
	 * Constraint:
	 *     (elt=Element text=Text add+=AddCondition* operations+=Operation*)
	 */
	protected void sequence_FindIf_WhileLoop(ISerializationContext context, FindIf semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Verify(ISerializationContext context, Verify semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MyDslPackage.Literals.VERIFY__HTML_FUNC) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MyDslPackage.Literals.VERIFY__HTML_FUNC));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVerifyAccess().getEltElementParserRuleCall_2_0(), semanticObject.getElt());
		feeder.accept(grammarAccess.getVerifyAccess().getHtml_funcTextParserRuleCall_4_0(), semanticObject.getHtml_func());
		feeder.finish();
	}
